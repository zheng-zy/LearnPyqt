...
# Form implementation generated from reading ui file 'FutureDealDetail.ui'
#
...
class Ui_DockWidget(object):
    ...
    def retranslateUi(self, DockWidget):
        DockWidget.setWindowTitle(_translate("DockWidget", "期货成交明细", None))
